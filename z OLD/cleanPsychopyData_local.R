...
for (subject_id in subjects) {
  ...
  gain1 <- read.csv(file.path(datadir, fixfilename1), fileEncoding="UTF-8-BOM")
  gain2 <- read.csv(file.path(datadir, fixfilename2), fileEncoding="UTF-8-BOM")
  loss1 <- read.csv(file.path(datadir, fixfilename3), fileEncoding="UTF-8-BOM")
  loss2 <- read.csv(file.path(datadir, fixfilename4), fileEncoding="UTF-8-BOM")
  ...
  #summary(subject_cfr$fix_dur[subject_cfr$FirstFix])
  #summary(subject_cfr$fix_dur[subject_cfr$MiddleFix])
  #summary(subject_cfr$fix_dur[subject_cfr$LastFix])
