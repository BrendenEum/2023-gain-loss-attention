...
plt.numeric.rt = fixCross.rt.plt(cfr[cfr$study=="numeric",], xlim=c(-0.03,1.03))
ggsave(
...
plt.numeric.prfirst = fixCross.prfirst.plt(cfr[cfr$study=="numeric",], xlim=c(0.22,1.03))
ggsave(
...
plt.numeric.mid = fixCross.mid.plt(cfr[cfr$study=="numeric",], xlim=c(-.03,1.03))
ggsave(
...
plt.numeric.net = fixCross.net.plt(cfr[cfr$study=="numeric",], xlim=c(-1.03,1.03))
ggsave(
...
plt.numeric.lastfix = fixCross.lastfix.plt(cfr[cfr$study=="numeric",], xlim=c(-1.03,1.03))
ggsave(
