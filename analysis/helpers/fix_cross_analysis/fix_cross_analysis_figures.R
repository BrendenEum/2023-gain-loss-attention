...
for (dataset in c("e/cfr_numeric.RData")) { #, "c/cfr_numeric.RData", "j/cfr_numeric.RData")) {
  
  load(file.path(datadir, dataset))
  cfr = cfr_numeric
  if (dataset=="e/cfr_numeric.RData") {ext="_E.pdf"}
  else if (dataset=="c/cfr_numeric.RData") {ext="_C.pdf"}
  else {ext="_J.pdf"}
  ...
  plt.numeric.psycho = fixCross.choice.plt(cfr[cfr$dataset=="numeric",], xlim=c(-4,4))
  ggsave(
  ...
  plt.numeric.rt = fixCross.rt.plt(cfr[cfr$dataset=="numeric",], xlim=c(0,4))
  ggsave(
  ...
  plt.numeric.prfirst = fixCross.prfirst.plt(cfr[cfr$dataset=="numeric",], xlim=c(1,4))
  ggsave(
  ...
  plt.numeric.first = fixCross.first.plt(cfr[cfr$dataset=="numeric",], xlim=c(0,4))
  ggsave(
  ...
  plt.numeric.mid = fixCross.mid.plt(cfr[cfr$dataset=="numeric",], xlim=c(0,4))
  ggsave(
  ...
  plt.numeric.net = fixCross.net.plt(cfr[cfr$dataset=="numeric",], xlim=c(-4,4))
  ggsave(
  ...
  plt.numeric.netfix = fixCross.netfix.plt(cfr[cfr$dataset=="numeric",], xlim=netfix_x_scale)
  ggsave(
  ...
  plt.numeric.lastfix = fixCross.lastfix.plt(cfr[cfr$dataset=="numeric",], xlim=c(-4,4))
  ggsave(
  ...
  plt.numeric.firstfix = fixCross.firstfix.plt(cfr[cfr$dataset=="numeric",], xlim=firstfix_x_scale)
  ggsave(
