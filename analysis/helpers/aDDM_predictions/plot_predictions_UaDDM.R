...
.simdir = file.path(paste0("../../outputs/temp/model_predictions/", .datetime, "/UaDDM"))
.estFN = "/Users/brenden/Desktop/2023-gain-loss-attention/analysis/helpers/aDDM_predictions/SimIndividualEstimates_UaDDM.csv"
.finalFigFN = "ModelPredictions_UaDDM.pdf"
.nSims = 10
#---------------------------------------------------------------
