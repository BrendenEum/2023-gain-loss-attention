...
full_data = ADDM.load_data_from_csv(
    "processed_data/numeric/" * dataset * "/expdataGain_train.csv", 
    "processed_data/numeric/" * dataset * "/fixationsGain_train.csv", 
);
#---------------------------------------------------------------------------------------
...
send_imessage("+17149067269", "Fitting Study2G has finished.") 