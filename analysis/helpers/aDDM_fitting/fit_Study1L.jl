...
# Participants
study_participants = DataFrame(CSV.File("Study1_participants_e.csv", delim=","))[:,1];

# Directories
tempdir = "results/study1L/";
dataset = "e"

# Data
full_data = ADDM.load_data_from_csv(
    "processed_data/dots/" * dataset * "/expdataLoss_train.csv", 
    "processed_data/dots/" * dataset * "/fixationsLoss_train.csv", 
);
#---------------------------------------------------------------------------------------
...
send_imessage("+17149067269", "Fitting Study1L has finished.") 