...
load(file.path(tempdir, "fdots_sim_GDaDDM.RData"))
load(file.path(tempdir, "fnumeric_sim_GDaDDM.RData"))
...
ggsave(
  file.path(figdir, paste0("sims_choice_GDaDDM", ext)), 
...
ggsave(
  file.path(figdir, paste0("sims_rt_GDaDDM", ext)), 
...
ggsave(
  file.path(figdir, paste0("sims_net_GDaDDM", ext)), 
...
ggsave(
  file.path(figdir, paste0("sims_last_GDaDDM", ext)), 
