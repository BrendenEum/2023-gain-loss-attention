...
load(file.path(tempdir, "fdots_sim_AddDDM.RData"))
load(file.path(tempdir, "fnumeric_sim_AddDDM.RData"))
...
ggsave(
  file.path(figdir, paste0("sims_choice_AddDDM", ext)), 
...
ggsave(
  file.path(figdir, paste0("sims_rt_AddDDM", ext)), 
...
ggsave(
  file.path(figdir, paste0("sims_net_AddDDM", ext)), 
...
ggsave(
  file.path(figdir, paste0("sims_last_AddDDM", ext)), 
