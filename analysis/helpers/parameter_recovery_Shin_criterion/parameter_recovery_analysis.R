...
date_folder = "sigma-just-below-Shin-boundary" # yyyy.mm.dd.H.M of the results you want to look at.
...
pdata$variable = factor(
  ...
  labels = c("d","sigma","theta","bias","decay", "reference")
)
