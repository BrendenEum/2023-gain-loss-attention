...
for (dataset in c("ecfr.RData", "ccfr.RData", "jcfr.RData") ) { 
  ...
  reg.numeric.durationtype = fixprop.durationtype.ttest(
    ...
    study="numeric",
    dataset=dataset)
  rm(reg.dots.durationtype)
  rm(reg.numeric.durationtype)
  ...
  reg.numeric.firstfix = bias.firstfix.reg(
    ...
    study="numeric",
    dataset=dataset)
  rm(reg.dots.firstfix)
  rm(reg.numeric.firstfix)
  ...
  reg.numeric.firstLeft = addfixprop.firstLeft.reg(
    ...
    study="numeric",
    dataset=dataset)
  rm(reg.dots.firstLeft)
  rm(reg.numeric.firstLeft)
