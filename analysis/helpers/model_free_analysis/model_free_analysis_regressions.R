...
iter = 90 # warmup + posterior samples
brm <- function(...)
  brms::brm(
    ...,
...
for (dataset in c("ecfr.RData")) { #, "ccfr.RData", "jcfr.RData")) {
  ...
  reg.dots.psycho = psycho.choice.reg(
    cfr[cfr$dataset=="dots",], 
    study="dots",
    dataset=dataset)
  reg.numeric.psycho = psycho.choice.reg(
    cfr[cfr$dataset=="numeric",], 
    study="numeric",
    dataset=dataset)
  #reg.food.psycho = psycho.choice.reg(
  #  cfr[cfr$dataset=="food",], 
  #  study="food",
  #  dataset=dataset)
  ...
  reg.numeric.numfix = psycho.numfix.reg(
    ...
    study="numeric",
    dataset=dataset)
  #reg.food.numfix = psycho.numfix.reg(
  #  cfr[cfr$dataset=="food",], 
  #  study="food",
  #  dataset=dataset)
  ...
  reg.numeric.prfirst = fixprop.prfirst.reg(
    ...
    study="numeric",
    dataset=dataset)
  #reg.food.prfirst = fixprop.prfirst.reg(
  #  cfr[cfr$dataset=="food",], 
  #  study="food",
  #  dataset=dataset)
  ...
  reg.numeric.durationtype = fixprop.durationtype.ttest(
    ...
    study="numeric",
    dataset=dataset)
  #reg.food.durationtype = fixprop.durationtype.ttest(
  #  cfr[cfr$dataset=="food",], 
  #  study="food",
  #  dataset=dataset)
  ...
  reg.numeric.first = fixprop.first.reg(
    ...
    study="numeric",
    dataset=dataset)
  #reg.food.first = fixprop.first.reg(
  #  cfr[cfr$dataset=="food",], 
  #  study="food",
  #  dataset=dataset)
  ...
  reg.numeric.netfix = bias.netfix.reg(
    ...
    study="numeric",
    dataset=dataset)
  #reg.food.netfix = bias.netfix.reg(
  #  cfr[cfr$dataset=="food",], 
  #  study="food",
  #  dataset=dataset)
  ...
  reg.numeric.lastfix = bias.lastfix.reg(
    ...
    study="numeric",
    dataset=dataset)
  #reg.food.lastfix = bias.lastfix.reg(
  #  cfr[cfr$dataset=="food",], 
  #  study="food",
  #  dataset=dataset)
  ...
  reg.numeric.firstfix = bias.firstfix.reg(
    ...
    study="numeric",
    dataset=dataset)
  #reg.food.firstfix = bias.firstfix.reg(
  #  cfr[cfr$dataset=="food",], 
  #  study="food",
  #  dataset=dataset) 
