...
function dstm_likelihood(;model::ADDM.aDDM, trial::ADDM.Trial, timeStep::Number = 10.0, approxStateStep::Number = 0.1)
    ...
    barrierUp = exp.(0 .* (0:numTimeSteps-1))
    barrierDown = -exp.(0 .* (0:numTimeSteps-1))
