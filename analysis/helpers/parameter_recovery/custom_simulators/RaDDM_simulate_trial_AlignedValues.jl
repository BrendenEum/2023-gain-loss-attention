...
"""
function RaDDM_simulate_trial_AlignedValues(;model::ADDM.aDDM, fixationData::ADDM.FixationData, 
    ...
    ZeroAmt_RD = 0 - minOutcome - 5

    LAmt_RD = LAmt - minOutcome - 5
    vL = (LProb * LAmt_RD) + ((1-LProb) * ZeroAmt_RD)

    RAmt_RD = RAmt - minOutcome - 5
