...
function RaDDM_simulator(;model::ADDM.aDDM, fixationData::ADDM.FixationData, 
                        valueLeft::Number, valueRight::Number, 
                        timeStep::Number=10.0, numFixDists::Int64=3, cutOff::Number=100000)
    
    vL = valueLeft - model.reference
    vR = valueRight - model.reference
    fixUnfixValueDiffs = Dict(1 => vL - vR, 2 => vR - vL)
