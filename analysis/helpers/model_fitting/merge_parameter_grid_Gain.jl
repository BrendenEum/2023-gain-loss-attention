...
fn = parameter_grid_folder*"aDDM_Gain_"*subject*".csv";
...
fn = parameter_grid_folder*"AddDDM_Gain_"*subject*".csv";
tmp = DataFrame(CSV.File(fn, delim=","));
...
fn = parameter_grid_folder*"RaDDM_Gain_"*subject*".csv";
tmp = DataFrame(CSV.File(fn, delim=","));
...
global param_grid_Gain = Dict(param_grid1..., param_grid2..., param_grid3...)