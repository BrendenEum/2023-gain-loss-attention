...
coord.lim <- 1
margin = .1
theta_gradient <- expand.grid(x=seq(-margin,coord.lim+margin,(coord.lim+2*margin)/gradient_resolution), y=seq(1-margin,1+coord.lim+margin,(coord.lim+2*margin)/gradient_resolution))
...
ggsave(
  file.path(.figdir, "aDDM_IndividualEstimates.pdf"), 
  plt.compare.param.e)
