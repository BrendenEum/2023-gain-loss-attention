...
.codedir = getwd()
.tempdir = file.path("../../outputs/temp/out_of_sample_simulations")
...
write.csv(estimates[estimates$study==1,], file=file.path(.tempdir,"study1estimates.csv"), row.names=F)
write.csv(estimates[estimates$study==2,], file=file.path(.tempdir,"study2estimates.csv"), row.names=F)
