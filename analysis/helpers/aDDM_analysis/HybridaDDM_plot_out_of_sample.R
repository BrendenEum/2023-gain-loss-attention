...
.simdir = file.path("../../outputs/temp/out_of_sample_simulations/2024.07.14.13.14/HybridaDDM")
.nSims = 10
load(file.path(.cfrdir, paste0(.dataset, "cfr.RData")))
.cfr = ecfr
.fn = "HybridaDDM_OutOfSamplePredictions.pdf"
#---------------------------------------------------------------
...
ggsave(file.path(.figdir, .fn), plt.outsample, height=10, width=13, units="in")
