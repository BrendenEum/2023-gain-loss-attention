...
dots_est = read_estimates(fitdir=fitdir, study="dots", model="AddDDM", dataset="e")
numeric_est = read_estimates(fitdir=fitdir, study="numeric", model="AddDDM", dataset="e")
...
save(fdots_sim, file=file.path(tempdir, "fdots_sim_AddDDM.RData"))
...
save(fnumeric_sim, file=file.path(tempdir, "fnumeric_sim_AddDDM.RData"))
