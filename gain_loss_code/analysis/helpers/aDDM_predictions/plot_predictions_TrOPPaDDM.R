...
.simdir = file.path(paste0("../../outputs/temp/model_predictions/", .datetime, "/TrOPPaDDM"))
.estFN = "/Users/brenden/Desktop/2023-gain-loss-attention/analysis/helpers/aDDM_predictions/SimIndividualEstimates_TrOPPaDDM.csv"
.finalFigFN = "ModelPredictions_TrOPPaDDM.pdf"
.nSims = 10
#---------------------------------------------------------------
